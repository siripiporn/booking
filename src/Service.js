            ...
            <View style={styles.container}>
                <View style={{ flex: 1, flexDirection: 'column' }}>
                    <ScrollView  style={{ flex: 1, flexDirection: 'column' }}>
                        {/* Box 1 */}
                        <TouchableOpacity onPress={this.onSelectDoctor.bind(this)} style={styles.container_box}>
                            <View style={{ flexDirection: 'row', flex: 1, }}>
                                <View style={styles.box_start}>
                                    <Text style={styles.box_startContent}>บริการจัดฟัน</Text>
                                </View>
                                <View style={styles.box_end}>
                                    <Text style={styles.box_endContent}>SVG</Text>
                                </View>
                            </View>
                        </TouchableOpacity>
                        ...
                        <View style={styles.container_box}>
                            <View style={{ flexDirection: 'row', flex: 1, }}>
                                <View style={styles.box_start}>
                                    <Text style={styles.box_startContent}>บริการอุดฟัน</Text>
                                </View>
                                <View style={styles.box_end}>
                                    <Text style={styles.box_endContent}>SVG</Text>
                                </View>
                        ...
                        <View style={styles.container_box}>
                            <View style={{ flexDirection: 'row', flex: 1, }}>
                                <View style={styles.box_start}>
                                    <Text style={styles.box_startContent}>บริการขูดหินปูน</Text>
                                </View>
                                <View style={styles.box_end}>
                                    <Text style={styles.box_endContent}>SVG</Text>
                                </View>
                        ...
                        <View style={styles.container_box}>
                            <View style={{ flexDirection: 'row', flex: 1, }}>
                                <View style={styles.box_start}>
                                    <Text style={styles.box_startContent}>บริการรักษารากฟัน</Text>
                                </View>
                                <View style={styles.box_end}>
                                    <Text style={styles.box_endContent}>SVG</Text>
                                </View>
...
const styles = StyleSheet.create({
    ...
    box_start: {
        flexDirection: 'column', flex: 1, height: hp('8%'), justifyContent: 'center', alignItems: 'flex-start'
    },
    box_startContent: {
    ...
    box_end: {
        flexDirection: 'column', flex: 1, height: hp('8%'), justifyContent: 'center', alignItems: 'flex-end'
    },
    box_endContent: {
