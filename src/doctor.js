                        ...
                        <View style={styles.container_box}>
                            <View style={{ flexDirection: 'row', flex: 1, }}>
                                <View style={styles.box_start}>
                                    <Text style={styles.box_startContent}>Lorem ipsum</Text>
                                    <Text style={styles.content}>Lorem ipsum dolor sitamet, consectetur adipiscing elit. </Text>
                                    <Text style={styles.contentSection}>Lorem ipsum dolor sitamet, consectetur adipiscing elit. </Text>
                                </View>
                                <View style={styles.box_end}>
                                    <View style={styles.box_endContent}>
                                    <Image style={{ width: 87, alignSelf: 'center', height: 100 }} source={require('../image/doctorImage.png')} />
                                    </View>
                                </View>
                            </View>
                        </View>
